export type MctpV2 = {
	...
	instructions: [
		{
			...
			discriminator: [112, 171, 205, 105, 227, 59, 197, 128];
			accounts: [
				{
					name: 'ledger';
					writable: true;
		...
		{
			name: 'bridgeWithFee';
			discriminator: [141, 239, 37, 224, 28, 231, 237, 51];
			accounts: [
				{
					name: 'ledger';
					writable: true;
		...
		{
			name: 'claimOrder';
			discriminator: [164, 202, 83, 197, 77, 171, 96, 234];
			accounts: [
				{
					name: 'cctpClaim';
					accounts: [
		...
		},
		{
			...
			discriminator: [31, 43, 233, 57, 62, 243, 215, 107];
			accounts: [
				{
					name: 'order';
					writable: true;
		...
		{
			name: 'flashSwapStart';
			discriminator: [210, 86, 206, 176, 90, 195, 113, 50];
			accounts: [
				{
					name: 'order';
					writable: true;
		...
		},
		{
			...
			discriminator: [167, 102, 128, 106, 121, 118, 186, 76];
			accounts: [
				{
					name: 'trader';
					writable: true;
		...
		},
		{
			...
			discriminator: [143, 235, 252, 194, 211, 90, 134, 77];
			accounts: [
				{
					name: 'trader';
					writable: true;
		...
		},
		{
			...
			discriminator: [12, 95, 149, 164, 83, 122, 255, 241];
			accounts: [
				{
					name: 'orderState';
				},
		...
		{
			name: 'redeemWithFee';
			discriminator: [246, 208, 184, 183, 114, 154, 68, 122];
			accounts: [
				{
					name: 'vaa';
				},
		...
		},
		{
			...
			discriminator: [207, 144, 189, 10, 243, 75, 250, 30];
			accounts: [
				{
					name: 'vaa';
				},
		...
		{
			name: 'redeemWithFeeCustomPayloadShim';
			discriminator: [152, 48, 130, 52, 21, 71, 236, 5];
			accounts: [
				{
					name: 'cctpClaim';
					accounts: [
				...
				},
				{
					...
					docs: [
						'this is optional and need to pass if the posted vaa_unlock is null',
					];
				},
				{
		...
		{
			name: 'redeemWithFeeShim';
			discriminator: [223, 186, 23, 179, 213, 0, 91, 239];
			accounts: [
				{
					name: 'cctpClaim';
					accounts: [
		...
		{
			name: 'registerOrderShim';
			discriminator: [135, 97, 182, 223, 232, 126, 74, 190];
			accounts: [
				{
					name: 'order';
					writable: true;
		...
		{
			name: 'unlockFee';
			discriminator: [95, 219, 253, 5, 215, 222, 12, 79];
			accounts: [
				{
					name: 'vaa';
				},
		...
		{
			name: 'unlockFeeShim';
			discriminator: [87, 125, 217, 192, 24, 184, 230, 228];
			accounts: [
				{
					name: 'mintFrom';
				},
		...
		},
		{
			...
			discriminator: [122, 32, 107, 109, 136, 250, 139, 227];
			accounts: [
				{
					name: 'vaaUnlock';
				},
		...
		},
		{
			...
			discriminator: [153, 164, 15, 94, 22, 26, 195, 138];
			accounts: [
				{
					name: 'ledger';
					writable: true;
		...
		},
		{
			...
			discriminator: [173, 104, 218, 246, 6, 172, 116, 207];
			accounts: [
				{
					name: 'ledger';
					writable: true;
	...
	accounts: [
		...
		},
		{
			...
			discriminator: [34, 147, 108, 255, 240, 145, 64, 43];
		},
		{
			name: 'lockedFee';
			discriminator: [248, 71, 52, 103, 114, 233, 58, 19];
		},
		{
			name: 'orderDestSolanaState';
			discriminator: [198, 129, 44, 70, 167, 41, 108, 44];
		},
		{
			name: 'orderLedgerState';
			discriminator: [55, 52, 56, 210, 43, 133, 8, 80];
		},
		{
			name: 'orderSourceSolanaState';
			discriminator: [251, 166, 188, 142, 205, 71, 239, 203];
		},
	];
	events: [
		{
			name: 'bridgedLockedFee';
			discriminator: [162, 129, 40, 225, 193, 223, 66, 62];
		},
		{
			name: 'bridgedWithFee';
			discriminator: [147, 222, 57, 87, 100, 194, 196, 3];
		},
		{
			name: 'ledgerBridgeInitialized';
			discriminator: [162, 159, 206, 146, 56, 81, 123, 85];
		},
		{
			name: 'ledgerOrderInitialized';
			discriminator: [184, 47, 251, 219, 32, 203, 91, 45];
		},
		{
			name: 'orderCreated';
